...
- *Definition*: let $L \/ F$ field extension, $alpha in L$ algebraic. *Minimal polynomial* $p_alpha (x) = p_(alpha, F) (x)$ of $alpha$ over $F$ is the monic polynomial $f$ of smallest degree such that $f(0) = 0$.
