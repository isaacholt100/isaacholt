...
function downloadLinkProps(github: boolean, year: string, name: string, extension: string): Partial<ButtonProps> {
	return {
							...
							<Card border="light" bg="transparent" className="h-100">
								...
								<Card.Body className="d-flex flex-column">
									...
									<Row className="g-2">
										...
										<Col>
											<Button variant="light" className="w-100" {...downloadLinkProps(false, y.year, note.name, "pdf")}>
												<span className="d-flex align-items-center justify-content-center">
													<Icon path={mdiFile} size="24px" className="me-1" />
													PDF
												</span>
										...
										<Col>
											<Button variant="outline-light" className="w-100" {...downloadLinkProps(true, y.year, note.name, "typ")}>
												<span className="d-flex align-items-center justify-content-center">
